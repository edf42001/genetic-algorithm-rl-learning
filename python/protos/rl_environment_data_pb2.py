...
_ENVIRONMENTDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='lastActionReward', full_name='EnvironmentData.lastActionReward', index=1,
