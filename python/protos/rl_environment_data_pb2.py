...
# source: protos/rl_environment_data.proto
...
WinnerRequest = _reflection.GeneratedProtocolMessageType('WinnerRequest', (_message.Message,), {
  ...
  '__module__' : 'protos.rl_environment_data_pb2'
